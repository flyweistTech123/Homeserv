            ...
            <div className='acservice'>
                ...
                <div className="acservice14" >
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Double Door ( Inverter ) Refrigerator Checkup</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Double Door ( Non-Inverter ) Refrigerator Checkup</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Single Door Refrigerator Checkup</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Side-By-Side Door Refrigerator Checkup</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
...
export default HOC(Refrigerator_Repair)