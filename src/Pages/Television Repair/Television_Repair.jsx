            ...
            <div className='acservice'>
                ...
                <div className="acservice14" >
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Installation - Wall Mount 24 degree - 26 degree</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Installation - Wall Mount 32 degree - 43 degree</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Installation - Wall Mount 46 degree - 55 degree</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Installation - Wall Mount 65 degree</h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Uninstallation  below 46 degree </h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Uninstallation 46 degree- 55 degree </h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
                    ...
                    <div className="acservice15">
                        ...
                        <div className='acservice16'>
                            <div className="acservice17">
                                <h6>Uninstallation  65 degree </h6>
                                <p>Starts with ₹299  ( 45 mins)</p>
                                <hr />
...
export default HOC(Television_Repair)